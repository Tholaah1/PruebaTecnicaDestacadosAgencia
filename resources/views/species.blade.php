...
@section('contenido')
    ...
    <div class="row">
        ...
        <p>Estas listando todos los personajes que estan MUERTOS. Puedes revisar los demas personajes haciendo click en el boton de 
            ver la siguiente pagina al final de esta web, o devolverte a la pagina principal volver a ver las demas categorias de especies.
        </p>
