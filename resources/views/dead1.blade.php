...
@section('contenido')
    <br>
    <div class="row">
        <!-- ESTA ES LA VISTA QUE SE ENCARGA DE LISTAR LOS PRIMEROS 20 PERSONAJES ESTADO MUERTOS -->
        ...
        @endforeach
        <!-- Este formulario es el que envia el valor de la pagina que viene a continuacion con sus 20 personajes correspondientes, llevando el valor a traves de la ruta apiram.dead2 por el metodo POST. Este valor sera cargado en la vista dead2.blade.php y listara los siguientes 20 personajes -->
