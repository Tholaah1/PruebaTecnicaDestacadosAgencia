...
@section('tituloPagina', 'API RICK AND MORTY - PRUEBA TECNICA - CRIATURAS MITOLOGICAS')

@section('contenido')
    <br>
    <div class="row">
        <!-- ESTA ES LA VISTA QUE SE ENCARGA DE LISTAR LOS PRIMEROS 20 PEROSNAJES DE TIPO CRIATURAS MITOLOGICAS. ESTA VISTA LUEGO LLAMA A LA VISTA SPECIES.BLADE.PHP PARA PODER SEGUIR LISTANDO LOS SIGUIENTES PERSONAJES -->
        <h1>Prueba tecnica - Consumo API Rick and Morty - Nicolás Toledo</h1>
        <p>Estas listando todos los personajes que son Criaturas Mitologicas, puedes revisar todos los demas personajes haciendo click en el boton de 
