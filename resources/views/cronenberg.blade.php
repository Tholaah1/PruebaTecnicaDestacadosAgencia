...
@section('contenido')
    <br>
    <div class="row">
        <!-- ESTA ES LA VISTA QUE SE ENCARGA DE LISTAR LOS PRIMEROS 20 PEROSNAJES DE TIPO CRONENBERG. ESTA VISTA LUEGO LLAMA A LA VISTA SPECIES.BLADE.PHP PARA PODER SEGUIR LISTANDO LOS SIGUIENTES PERSONAJES -->
