...
@section('tituloPagina', 'API RICK AND MORTY - PRUEBA TECNICA - ALIENS')

@section('contenido')
    <br>
    <div class="row">
        <!-- ESTA ES LA VISTA QUE SE ENCARGA DE LISTAR LOS PRIMEROS 20 PEROSNAJES DE TIPO ALIENS. ESTA VISTA LUEGO LLAMA A LA VISTA SPECIES.BLADE.PHP PARA PODER SEGUIR LISTANDO LOS SIGUIENTES PERSONAJES -->
        <h1>Prueba tecnica - Consumo API Rick and Morty - Nicolás Toledo</h1>
        <p>Estas listando todos los personajes que son Aliens, puedes revisar los demás personajes haciendo click en el botón de 
            "Ir a la siguiente página" al final de esta web, o devolverte a la página principal para ver las otras categorias de especies.
        </p>
